  ...
  $(document).ready(function(){
    ...
    $('.no').click(function(){
      $('.EditFieldPop').hide();
                    ...
                    <div class="gallery_img mar_bm_20 text-center"><video width="auto" max-height ="310px" controls>
											<source src="<?php echo base_url($val['uri']); ?>" >
										</video></div>
							<?php } else { ?>
                     <div class="gallery_img mar_bm_20 text-center"><img src="<?php echo base_url($val['uri']);?>" width="auto"></div>
                        <?php } ?>
						<?php } } ?>
					</div>
