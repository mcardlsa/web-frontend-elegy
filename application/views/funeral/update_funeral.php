        	...
        	<div class="form-1">
				...
				<div class="register_form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" name="about"><?php $x = str_replace('*#*',"\n",$funeral_detail['about']);
					echo  $x; ?></textarea>
                        ...
                        <div class="dropdown form-group position-relative custom-select">
							...
							?>
                                ...
                                <div class="circle_box pop_show circle_box_<?php echo $j;?>">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="event<?php echo $j;?>[]" class="form-control" id="datetimepicker<?php echo $j;?>" value="<?php if(isset($event[$k]['time'])) $gmttime=strtotime($event[$k]['time']);					
												$user_timezone = $_COOKIE['utimezone'];
												$user=($user_timezone*60*60);
												$orderLocalTime=$gmttime+$user;
												echo date('Y/m/d H:i',$orderLocalTime);?>">
                                    <?php echo form_error('event'); ?>
									</div>
